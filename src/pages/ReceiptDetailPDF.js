...
const styles = StyleSheet.create({
  ...
  const ReceiptDetailPDF = ({ receiptID, receiptData,purchaseOrderData, quotationData, productData, productPOData, total, vat, grandTotal }) => (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          <Text style={styles.headerText}>Receipt No: {receiptID}      Issued Date: {receiptData.issuedDate}           Refer to:{purchaseOrderData.id}</Text>
  ...
  export default ReceiptDetailPDF;